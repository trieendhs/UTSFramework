	...
	<body>
		<div class="container-fluid">
				<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
					...
					<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
						<div class="jumbotron" style="background-image: url('<?= base_url('images/HfURRwV.jpg'); ?>')">
							<div class="container">
								...
								<?php 
									echo anchor('hero/index/'.$this->uri->segment(3), 'Lihat Data');
									echo "<br><br>"; ?>
								<span class="glyphicon glyphicon-grain" aria-hidden="true"></span>
								<?php
									echo anchor('jenis/index', 'Back To Home');
 								?>
 								</font>
 								</h2>
							</div>
